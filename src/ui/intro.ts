...
/**
 * Outbound links on the title screen.
 *
 * Both labels are proper nouns, untranslated in all nineteen locales, so
 * neither needs a locale key. `noreferrer` matters on the second one: the
 * original site is http-only, and without it an https referrer would be sent
 * over plaintext.
 */
...
<p class="source-links">
  ...
  <a class="source-link" href="http://newsgaming.com/games/index12.htm"
     target="_blank" rel="noopener noreferrer">
    <svg class="source-link__mark" viewBox="0 0 16 16" aria-hidden="true"
         fill="none" stroke="currentColor" stroke-width="1.6"
         stroke-linecap="round" stroke-linejoin="round">
      <path d="M9.5 2.5H13.5V6.5" />
      <path d="M13.5 2.5 7.5 8.5" />
      <path d="M12.5 9.7v3.3a.8.8 0 0 1-.8.8H3a.8.8 0 0 1-.8-.8V4.3a.8.8 0 0 1 .8-.8h3.3" />
    </svg>
    <span>Newsgaming.com</span>
  </a>
</p>`
